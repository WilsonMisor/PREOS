...
now=datetime.datetime.now(datetime.timezone.utc).isoformat(); dump_json(rt/'PIPELINE-STATE.json',{'project_id':a.project_id,'created_at':now,'state':'INITIALIZED'}); dump_json(rt/'CURRENT-STATE.json',{'project_id':a.project_id,'updated_at':now,'current_stage':'project-init'}); dump_json(rt/'approval-state.json',{'project_id':a.project_id,'approvals':[]}); dump_json(rt/'evidence-index.json',{'project_id':a.project_id,'evidence':[]})
